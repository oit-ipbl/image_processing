...
- The process after `cap.read()` function in the while block is skipped and continued the iteration if the next iteration is came up before the next frame is provided from the video stream.
